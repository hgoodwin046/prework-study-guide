...
The prework study guide can be used for notes on the topics of HTML, CSS, JavaScript, and Git.  If we open the DevTools console we can see the JavaScript running  
